...
import SaygoodbyeCounter from "./SaygoodbyeCounter";
    ...
    return (
        <div className="xxl:ml-[360px] xxl:mt-[160px]">
            ...
            <div className="flex flex-col xl:flex-row justify-center mb-[48px] md:mb-[64px] xl:justify-between">
                <SaygoodbyeCounter />
                <div className="flex flex-col gap-[24px] md:w-[390px]">
                    <InlineLink>Hear about the cost savings</InlineLink>
                    <InlineLink>The full cost comparison</InlineLink>
                </div>
            </div>
            <div className="flex mt-auto">
                <div className="flex gap-[16px] lg:gap-[64px] justify-center xl:items-start xl:justify-start lg:flex-row flex-col">
                    <button className="cursor-pointer w-fit bg-neutral-800 text-white font-regular text-h6 leading-h6 py-[12px] px-[16px] hover:bg-white hover:text-black transition duration-150">Fixed cost savings</button>
