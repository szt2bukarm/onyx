    ...
    return (
        <div className="flex h-auto lg:h-[600px] flex-col lg:flex-row">
            ...
            <div className="section-padding bg-onyx-500 flex flex-col w-full lg:w-[50%]">
                ...
                <p className="font-regular text-md leading-md text-neutral-700 mb-[32px] sm:mb-[120px]">Leaks, hacks, abuse, mistakes. Errors both internal and external. Data is your competitive advantage. Privacy is a right.</p>
