    ...
    return (
        <div className="flex flex-col gap-[48px] font-regular border border-black w-full">
            ...
            <div className="flex flex-col h-full px-[24px] pb-[24px] sm:px-[48px] sm:pb-[48px]">
                ...
                {/* <button className="group cursor-pointer mt-auto font-medium transition duration-150 w-fit flex items-center gap-[24px] px-[24px] py-[12px] border border-black/100 text-black hover:bg-black hover:text-white mt-auto">
                    {button}
