...
export default function Upgrade() {
    return (
        <div className="section-padding flex flex-col xl:flex-row gap-[48px] xl:gap-[120px]">
            <Heading className="font-regular text-mobileheading leading-mobileheading sm:text-h3 sm:leading-h3 xl:text-h2 xl:leading-h2 text-neutral-800 xl:min-w-[464px] xl:max-w-[464px]">A Non-Negotiable Upgrade:</Heading>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-[8px]">

                <div className="p-[24px] flex flex-col items-start bg-creambg sm:min-h-[196px] gap-[16px] sm:gap-0">
