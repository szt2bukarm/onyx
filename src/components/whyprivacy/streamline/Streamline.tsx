...
export default function Streamline() {
    return (
        <div className="section-padding bg-white">
            <Heading className="font-regular text-mobileheading leading-mobileheading sm:text-h3 sm:leading-h3 xl:text-h2 xl:leading-h2 text-neutral-800 mb-[48px]">Streamline Regulatory Compliance</Heading>

            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-[8px]">

                <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-creambg">
                    <p className="font-medium text-lg leading-lg text-neutral-700 mb-[8px] sm:mb-0">GDPR “Privacy by Design”</p>
                ...
                <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-creambg">
                    <p className="font-medium text-lg leading-lg text-neutral-700 mb-[8px] sm:mb-0">Reduce Liability</p>
                ...
                <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-creambg">
                    <p className="font-medium text-lg leading-lg text-neutral-700 mb-[8px] sm:mb-0">Future-Proof Attacks</p>
                ...
                <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-creambg">
                    <p className="font-medium text-lg leading-lg text-neutral-700 mb-[8px] sm:mb-0">Future-Proof Regulation</p>
