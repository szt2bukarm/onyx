export default function RecentBreachesCards() {
    return (
        ...
        <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-neutral-700">
            <p className="font-medium text-lg leading-lg text-white mb-[8px] sm:mb-0">Dangerous Plaintext Liabilities</p>
        ...
        <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-neutral-700">
            <p className="font-medium text-lg leading-lg text-white mb-[8px] sm:mb-0">Regulatory and Legal Ramifications</p>
        ...
        <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-neutral-700">
            <p className="font-medium text-lg leading-lg text-white mb-[8px] sm:mb-0">Executive Personal Liability</p>
        ...
        <div className="flex flex-col sm:min-h-[240px] p-[24px] bg-neutral-700">
            <p className="font-medium text-lg leading-lg text-white mb-[8px] sm:mb-0">AI Pipeline Exposure</p>
