...
export default function CryptographicProofs() {
    return (
        <div className="section-padding bg-white">
            <Heading className="font-regular text-mobileheading leading-mobileheading sm:text-h3 sm:leading-h3 xl:text-h2 xl:leading-h2 text-neutral-800 mb-[48px]">Onyx Cryptographic Proofs</Heading>

            <div className="flex flex-col lg:flex-row gap-[16px] min-h-auto md:min-h-[640px] sm:mb-[48px]">
                <div className="flex flex-col gap-[24px] sm:gap-[48px] font-regular border border-black w-full">
