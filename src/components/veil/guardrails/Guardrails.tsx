...
export default function Guardrails() {
    return (
        <div className="pt-[120px] pr-[20px] sm:pr-[80px] sm:pl-[80px] xl:pr-0 pl-[20px] pb-[80px] flex flex-col xl:flex-row gap-[40px] xl:gap-[120px]">

            <div className="flex flex-col xl:min-w-[40%]">

                <Heading className="font-regular text-h4 leading-h4 sm:text-h3 sm:leading-h3 xl:text-h2 xl:leading-h2 text-neutral-800 mb-[24px]">Guardrails for your AI Copilots</Heading>
