...
export default function EarlyAccessForm() {
    return (
        <form className="sm:p-[48px] flex flex-col justify-center gap-[32px] xl:w-[40%] sm:bg-neutral-600">
            ...
            <div className="flex flex-col gap-[10px] sm:gap-[24px]">
                ...
                <div className="flex flex-col md:flex-row gap-[10px] sm:gap-[24px] md:gap-[8px] ">
