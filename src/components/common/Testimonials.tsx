...
export default function Testimonials({color = "white"}: {color: string}) {
    return (
        <div className={`
            ${color === 'black' ? " bg-neutral-800" : ""}
            ${color === 'white' ? " bg-white" : ""}
        `}>
            <Heading className={`font-regular text-mobileheading leading-mobileheading sm:text-h3 sm:leading-h3 xl:text-h2 xl:leading-h2  mb-[48px]
