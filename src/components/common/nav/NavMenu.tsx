...
export default function NavMenu({setOpen} : {setOpen: React.Dispatch<React.SetStateAction<boolean>>}) {
    return (
        <div className="hidden flex-col gap-[48px] lg:flex overflow-y-auto max-h-[calc(100vh-100px)] overscroll-contain">

            {/* nav cards */}
            <div className="grid grid-cols-3 min-h-[400px]">

                <TransitionLink href="/firewall" setNavOpen={setOpen}>
                <div className="min-h-full cursor-pointer transition duration-100 hover:bg-onyx-500 flex flex-col gap-[24px] p-[48px] border-1 border-[#B4B4B41F]">
