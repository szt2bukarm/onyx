...
export default function Latency() {
    return (
        <div className="flex flex-col lg:flex-row w-full">
            ...
            {/* left */}
            <div className="p-[20px] py-[40px] sm:px-[80px] sm:py-[120px] flex flex-col gap-[40px] lg:w-[50%] bg-onyx-500">
                <Heading className="font-regular text-h4 leading-h4 md:text-h3 md:leading-h3 xl:text-h2 xl:leading-h2 w-auto text-neutral-700 ">Trade slight latency on your AI responses for the most bulletproof data privacy in the world</Heading>
                <InlineLink black>See speed benchmarks</InlineLink>
            </div>

            {/* right */}
            <div className="p-[20px] py-[40px] sm:p-[80px] flex flex-col gap-[40px] lg:w-[50%] bg-creambg">
