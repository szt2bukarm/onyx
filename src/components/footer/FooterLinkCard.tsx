...
export default function FooterLinkCard({image,text,button} : {image: string, text: string, button: string}) {
    return (
        <div className="flex flex-col w-full h-full p-[24px] md:p-[48px] bg-neutral-700">
            <div className="h-[60px] w-[60px] md:h-[100px] md:w-[100px] bg-onyx-500 flex justify-center items-center mb-[24px]">
                <img src="logoletters/o-black.svg" alt="letter o from ONYX logo" className="h-[28px] md:h-[48px]" />
            </div>
